...
import com.study.application.ui.SubscribeActivity;
                                ...
                                for (FirebaseVisionBarcode barcode : firebaseVisionBarcodes) {
                                    ...
                                    switch (valueType) {
                                        case FirebaseVisionBarcode.TYPE_TEXT:
                                            ...
                                            }else if (scannedTarget.equals("SUBSCRIBEITEM")) {
                                            intent.setClass(ScanQrCodeActivity.this, SubscribeActivity.class);
                                            setResult(SubscribeActivity.REQUEST_CODE, intent);
                                            }
